...
This repo is a partial copy of https://github.com/udacity/sagemaker-deployment.git.
...
```bash
cd SageMaker
git clone https://github.com/Doc-Ix/MLCommunity_SageMaker_II.git
exit
```
